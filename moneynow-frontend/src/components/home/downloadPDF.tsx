...
//       case "SIP Growth":
//         summaryData.push(
//           ["Monthly SIP", formatValue(result.sip_amount)],
...
//         summaryData.push(
//           ["Monthly SIP", formatValue(result.sip_amount)],
//           ["Step-Up %", formatValue(result.sip_stepup_value, true)],
//           ["Interest Rate", formatValue(result.interest_rate, true)],
//           ["Period (Months)", result.period ?? "—"],
//           ["Invested Amount", formatValue(result.invested_amount)],
//           [
...
//           ["Target Retirement Corpus", formatValue(result.target_amount)],
//           ["Monthly Savings Required", formatValue(result.monthly_savings)],
//           ["Total Earnings", formatValue(result.total_earnings)],
//           ["Inflation Rate", formatValue(result.inflation_rate, true)],
//           ["Expected Return", formatValue(result.expected_return, true)],
//         );
...
//     // Yearly breakdown table if present
...
//           typeof val === "number"
//             ? `${rupee}${val.toLocaleString("en-IN")}`
//             : val,
//         ),
//       );
...
//           ["Future Value", formatValue(result.future_amount)],
//         );
//         break;
...
//           ["Inflation Rate", formatValue(result.inflation_rate, true)],
//           ["Expected Return", formatValue(result.expected_return, true)],
//           ["Current Savings", formatValue(result.savings_amount)],
//           ["Target Dream Amount", formatValue(result.target_dream_amount)],
//           ["Monthly Savings Required", formatValue(result.monthly_savings)],
//           ["Total Invested", formatValue(result.invested_amount)],
//           ["Total Earnings", formatValue(result.total_earnings)],
//           ["Target Amount", formatValue(result.target_amount)],
//         );
//         break;
...
//       case "Target Amount SIP":
//         summaryData.push(
//           ["Target Amount", formatValue(result.wealth_amount)],
//           ["Inflation Rate", formatValue(result.inflation_rate, true)],
//           ["Expected Return", formatValue(result.expected_return, true)],
//           ["Period (Years)", result.period],
//           ["Target Wealth", formatValue(result.target_wealth)],
//           ["SIP Amount Required", formatValue(result.sip_amount)],
//           ["Invested Amount", formatValue(result.invested_amount)],
...
//           ["Expected Return", formatValue(result.expected_return, true)],
//           ["Years", result.years],
//           ["Lumpsum Required", formatValue(result.lumpsum_amount)],
//         );
//         break;
...
//           ["Retirement Age", retirementAge ?? "—"],
//           ["Years to Retirement", result.years],
//           ["Desired Wealth", formatValue(result.wealth_amount)],
//           ["Inflation Rate", formatValue(result.inflation_rate, true)],
//           ["Expected Return", formatValue(result.expected_return, true)],
//           ["Current Savings", formatValue(result.savings_amount)],
//           ["Target Wealth", formatValue(result.target_wealth)],
...
//           ["Total Invested", formatValue(result.invested_amount)],
//           ["Total Earnings", formatValue(result.total_earnings)],
//           ["Retirement Corpus Required", formatValue(result.target_amount)],
//         );
//         break;
...
//           ["Interest Rate", formatValue(result.interest_rate, true)],
//           ["Loan Tenure", `${result.loan_tenure} Years`],
//           ["EMI Amount", formatValue(result.emi)],
//           ["Total Interest", formatValue(result.total_interest)],
//           ["Total Amount Payable", formatValue(result.total_amount)],
//         );
//         break;

//       case "SWP":
//         summaryData.push(
//           ["Lumpsum Invested", formatValue(result.invested_amount)],
//           ["Monthly Withdrawal", formatValue(result.withdrawal_amount)],
...
//           ["Inflation Rate", formatValue(result.inflation_rate, true)],
//           ["Number of Years", result.no_years],
...
//           ["Current Savings", formatValue(result.savings_amount)],
//           [
//             "Total Education Amount Required",
...
//           ["Years", result.years],
//           ["Total Savings", formatValue(result.savings_amount)],
//           [
...
//     // Yearly breakdown table for Step-Up SIP
//     if (
