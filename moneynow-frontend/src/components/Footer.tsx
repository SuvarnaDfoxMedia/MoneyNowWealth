    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 text-[#FFFFFF] px-4">
          ...
          <div className="max-w-7xl mx-auto  py-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-6">
              ...
              <p className="text-[15px] leading-relaxed max-w-lg">
                Helping investors make informed, long-term investment decisions
                through simple tools, practical learning, and transparent
                processes.
              </p>
            </div>
            ...
            <div className="lg:col-span-6 grid grid-cols-2 sm:grid-cols-3 gap-10">
              <div>
                <h4 className="font-semibold text-[16px] mb-5 border-b-1 border-[#FFFFFF] w-fit">
                  Explore
                </h4>
              ...
              <div>
                <h4 className="font-semibold text-[16px] mb-5 border-b-1 border-[#FFFFFF] w-fit text-[#FFFFFF]">
                  Legal & Support
                </h4>
                <ul className="space-y-3 text-[14px]">
                  <li>
          ...
          <div className="max-w-7xl mx-auto  py-8 border-t border-[#575757]/40 leading-[26px]">
            {/* Row 1: AMCs */}
            <div className="grid grid-cols-1 md:grid-cols-12 gap-2 mb-6">
              <div className="md:col-span-10 font-normal text-[#FFFFFF] text-[15px]">
                ...
                Aditya Birla Sun Life | Axis | Canara Robeco | DSP | Edelweiss |
                Franklin Templeton | HDFC | HSBC | ICICI Prudential | IDFC |
                Kotak | LIC | Mirae Asset | Motilal Oswal | Nippon India | PGIM
              ...
              <div className="md:col-span-2 text-left">
                ...
                >
                  View all AMCs{" "}
                  <HiOutlineArrowNarrowRight size={18} className="mt-0.5" />
                </Link>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-2 mb-6">
              <div className="md:col-span-10 text-[#FFFFFF] text-[15px]">
                ...
                SIP Calculator | Lumpsum Calculator | Goal Calculator |
                Retirement Calculator | SWP Calculator | ELSS Calculator | NPS
                Calculator
              </div>
              <div className="md:col-span-2 text-left">
                <Link
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-2">
              <div className="md:col-span-10 text-[#FFFFFF] text-[15px]">
                ...
                Funds | Index Funds | ETF | Overnight Funds
              </div>
              <div className="md:col-span-2 text-left">
                <Link
                  href="/popular-funds"
          ...
          <div className="max-w-7xl mx-auto  py-8 border-t border-white/20 grid grid-cols-1 md:grid-cols-2 gap-8 text-[15px]">
            <p>
              <span className="font-semibold text-[16px]">
      ...
      {/* Final Bottom Bar */}
      <div className="max-w-full  lg:px-12 py-5 flex flex-col md:flex-row justify-between items-center text-[#FFFFFF] bg-[#001325] border-t border-[#575757]/40">
        <p className="text-[16px] mb-6 md:mb-0">
          © 2026 <span className="font-bold">Moneynow</span>. All rights
          reserved.
        </p>
