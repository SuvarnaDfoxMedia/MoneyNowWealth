  ...
  return (
    <DashboardCard className="mt-4 rounded-[24px] p-6 md:p-7">
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <Link href="#" className="group inline-flex items-center gap-1 whitespace-nowrap shrink-0 rounded-sm bg-[#0A4A87] px-5 py-2 text-[14px] font-semibold text-white shadow-sm transition-all hover:bg-[#083A69]">
          View all
