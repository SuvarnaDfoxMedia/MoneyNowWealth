...
// import { API } from "@/app/api/axios"; // make sure API is imported
...
//     loading,
//     error,
//     refetch, // IMPORTANT: provided by useFetchProfile
//   } = useFetchProfile();
...
//             {/* Avatar */}
//             {profileImageUrl ? (
//               <div className="h-28 w-28 overflow-hidden rounded-full flex-shrink-0">
//                 <img
//                   src={profileImageUrl}
//                   alt="User"
...
//               </div>
//             ) : (
//               <div className="h-24 w-24 flex items-center justify-center rounded-full bg-blue-100 text-blue-600 flex-shrink-0">
//                 <FiUser size={28} />
//               </div>
//             )}
...
//   // Zustand setters for immediate global update
...
//       // Update Zustand store globally so all components reflect changes
...
export default function UserProfilePage() {
  ...
  const handleSaveProfile = async (formData: FormData) => {
    ...
    if (result.success) {
      ...
      // Optional: Refetch to ensure data is fresh
      setTimeout(() => {
        refetch();
      }, 500);
      ...
      // Return errors to the EditProfile component
      return {
        success: false,
        error: result.error,
