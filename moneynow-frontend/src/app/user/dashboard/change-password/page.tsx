...
//               className="max-w-[900px] grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6"
//             >
//               {/* Current Password */}
//               <div>
//                 <label
//                   className="block text-[15px] leading-[26px] mb-1"
//                   style={{ width: "134px" }}
//                 >
...
//                   className="w-full h-[40px] border border-[#E8E8E8] rounded px-3 text-[14px]
//                              focus:outline-none focus:ring-2 focus:ring-[#043F79]"
//                 />
//               </div>
...
//                 <button
//                   type="submit"
//                   className="bg-[#043F79] hover:bg-[#002b6d] text-white
//                              text-[14px] font-semibold px-8 py-[10px] rounded"
//                 >
//                   SAVE
//                 </button>
//               </div>
...
//                   value={currentPassword}
//                   onChange={(e) => setCurrentPassword(e.target.value)}
//                   className="w-full h-[40px] border border-[#E8E8E8] rounded px-3 pr-10 text-[14px]
//                              focus:outline-none focus:ring-2 focus:ring-[#043F79]"
//                   disabled={loading}
//                 />
//                 <span
...
//                   type="submit"
//                   disabled={loading}
//                   className="flex items-center gap-2 bg-[#043F79] hover:bg-[#002b6d] text-white
