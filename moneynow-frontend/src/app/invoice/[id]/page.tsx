// // app/invoice/payment/[id]/page.tsx
// "use client";
...
//     // temporarily remove any css filters or problematic styles
//     const element = invoiceRef.current;

//     html2canvas(element, {
//       scale: 2, // higher resolution
//       useCORS: true, // allow cross-origin images
//       backgroundColor: "#ffffff", // force background to white
//       allowTaint: true,
//       logging: false,
//       ignoreElements: (el) => {
//         // ignore elements that might break rendering, optional
//         return false;
//       },
//     })
//       .then((canvas) => {
...
//             />
//             <span className="text-2xl font-bold tracking-wide">Invoice</span>
//           </div>
...
//           <div>
//             <h3 className="uppercase text-gray-500 text-sm font-semibold mb-2">
//               Billed To
//             </h3>
//             <p className="text-gray-700 font-medium">
//               {invoice.user.firstname} {invoice.user.lastname}
//             </p>
//             <p className="text-gray-700 text-sm">{invoice.user.email}</p>
//           </div>
...
//               Company
//             </h3>
//             <p className="text-gray-700 font-medium">Your Company Name</p>
//             <p className="text-gray-700 text-sm">support@example.com</p>
//             <p className="text-gray-700 text-sm">+91 1234567890</p>
//           </div>
//         </div>
...
//                   <th className="p-4 border-b">Plan Name</th>
...
//             </div>
//             <div className="flex justify-between mt-2 border-t pt-2 text-lg font-bold">
...
//         {/* FOOTER */}
//         <div className="p-6 text-center text-gray-600 text-sm bg-gray-50">
//           <p className="mb-2">
...
//         console.error("PDF generation failed:", err);
//         alert(
//           "PDF generation failed. Make sure all background colors are hex values.",
//         );
//       });
//   };
