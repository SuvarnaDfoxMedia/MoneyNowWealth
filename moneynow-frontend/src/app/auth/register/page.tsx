...
// import IntlTelInputInstance from "intl-tel-input";
...
const Register = () => {
  ...
  return (
    <section className="w-full min-h-[135dvh] flex items-center md:bg-[url('/images/register-bg-3.png')] bg-no-repeat bg-cover bg-center">
      <Toaster position="top-right" reverseOrder={false} />

      <div className="container mx-auto px-4 sm:px-6 md:px-[70px] py-4 md:py-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          {/* LEFT SECTION */}
          <div className="md:col-span-7 self-center">
            <Image
