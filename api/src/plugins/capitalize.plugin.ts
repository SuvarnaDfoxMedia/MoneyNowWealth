...
//   const updateMiddleware = function (this: any, next: () => void) {
//     // Type-safe way to get update object
//     const update = (this as any).getUpdate ? (this as any).getUpdate() : null;
...
//           if (key === "$set" && typeof updateObj[key] === "object") {
//             Object.keys(updateObj[key]).forEach((nestedKey) => {
//               const value = updateObj[key][nestedKey];
//               if (value !== undefined && value !== null) {
//                 updateObj[key][nestedKey] = processFieldValue(nestedKey, value);
//               }
//             });
//           }
//           return;
...
//   // Apply middleware using type assertion to bypass TypeScript check
//   // This is safe because we know Mongoose supports these hooks
//   schema.pre("findOneAndUpdate" as any, updateMiddleware);
//   schema.pre("updateOne" as any, updateMiddleware);
//   schema.pre("updateMany" as any, updateMiddleware);
//   schema.pre("findByIdAndUpdate" as any, updateMiddleware);
// };
