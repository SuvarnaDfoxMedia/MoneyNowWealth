...
//   // ADDED FIELD for email notifications
...
//     // ADDED: Email notification tracking
...
// topicSchema.post(
//   "save",
//   async function (doc: ITopic, next: (err?: any) => void) {
...
// topicSchema.pre(
//   /^find/,
//   function (this: Query<any, ITopic>, next: (err?: any) => void) {
...
//   is_email_sent: 1, // Added for email query performance
// });
...
------------------------------ */
topicSchema.plugin(capitalizePlugin, {
  except: [
    // SEO/slug fields
    "slug",
    "topic_code",
