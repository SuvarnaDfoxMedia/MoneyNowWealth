...
export default function MFTopHoldingHistoryPage() {
  ...
  const historyQuery = useQuery({
    queryKey: [role, "mf-top-holdings-history", decodedSchemeId, page, recordsPerPage],
    queryFn: () =>
      axiosApi.get<HistoryRow[]>(`/${role}/mf/top-holdings/history/${encodeURIComponent(decodedSchemeId)}`, {
        page,
